...
# Navigate changes in source control diff (Alt+F5 / Alt+Shift+F5)
change next: key(alt-f5)
change last: key(alt-shift-f5)
# Chat editor navigation (AI-generated code changes)
#chat change next: user.vscode("chatEditor.action.navigateNext")
#chat change last: user.vscode("chatEditor.action.navigatePrevious")
...
debug exit: user.vscode("workbench.action.debug.stop")
